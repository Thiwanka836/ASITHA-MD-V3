...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=m7oV0J5K#SxMRJ1Js_6fxj1awn2jamlGGxaaH-47L3LqpL3cxDjk' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '94740938105,94740938105' : process.env.SUDO,
...
AUTO_VOICE: true.env.AUTO_VOICE === undefined ? "true" : process.env.AUTO_VOICE,
AUTO_REPLY: process.env.AUTO_REPLY === undefined ? "false" : process.env.AUTO_REPLY,
AUTO_STICKER: true.env.AUTO_STICKER === undefined ? "true" : process.env.AUTO_STICKER,
